...
export function HowItWorks() {
  return (
    <section id="how-it-works" className="py-20 md:py-24 bg-white border-b border-surface-200">
      <Container>
        ...
        <div className="grid gap-8 md:grid-cols-3">
          {steps.map((step, index) => (
            <motion.div
              ...
              className="relative group rounded-2xl bg-white p-8 shadow-soft ring-1 ring-surface-200 transition-all duration-300 hover:shadow-soft-lg hover:-translate-y-1"
            >
              <div className="mb-6 inline-flex h-12 w-12 items-center justify-center rounded-xl bg-primary-50 text-primary-600 group-hover:bg-primary-600 group-hover:text-white transition-colors duration-300">
                {step.icon}
              </div>
              ...
              <div className="absolute top-4 right-6 text-6xl font-black text-surface-100 -z-0 select-none pointer-events-none">
                {step.number}
              </div>
            </motion.div>
          ))}
