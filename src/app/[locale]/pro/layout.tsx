...
export default async function ProLayout({
  ...
  const t = await getTranslations('Layouts.Pro');

  const SIDEBAR_LINKS = [
    { label: t('links.dashboard'), href: "/pro", icon: "🏠" },
    { label: t('links.requests'), href: "/pro/requests", icon: "🔍" },
    { label: t('links.offers'), href: "/pro/offers", icon: "📤" },
    { label: t('links.jobs'), href: "/pro/jobs", icon: "💼" },
    { label: t('links.profile'), href: "/pro/profile", icon: "👤" },
