  ...
  const heroHighlights = [
    {
      ...
      value: pendingOffers > 0 ? t('highlights.reviewOffers') : openRequests > 0 ? t('highlights.waitingOffers') : t('highlights.createRequest'),
      helper: pendingOffers > 0
        ? t('highlights.offersToReview', { count: pendingOffers })
        : openRequests > 0
          ? t('highlights.openRequests', { count: openRequests })
    ...
    },
    {
      ...
      value: t('highlights.offersCount', { count: totalOffers }),
  ...
  return (
    <div className="space-y-6">
      <DashboardHero
        ...
        action={{ label: t('highlights.createRequest'), href: "/client/requests/new" }}
